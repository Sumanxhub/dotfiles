...
map(
  "n",
  "<leader>cf",
  "<cmd>lua vim.o.scrolloff = (vim.o.scrolloff == 999) and 0 or 999<CR>",
  { desc = "toggle scroll off", silent = true }
)
...
end, { desc = "toggleable vertical terminal" })

map({ "n", "t" }, "<A-h>", function()
  require("nvchad.term").toggle { pos = "sp", id = "htoggleTerm" }
end, { desc = "toggleable horizontal terminal" })
...
end, { desc = "Toggle On Markdown Rendering" })

map("n", "<leader>md", function()
  require("render-markdown").disable()
end, { desc = "Toggle Off Markdown Rendering" })
